...
try:
  version = dbutils.notebook.run("./train_model", 600, {"model_name": model_name, "stage": stage})
except Exception as e:
  raise e
...
try:
  dbutils.notebook.run("./deploy", 600, {"model_name": model_name, "stage": stage, "model_version": version})
except Exception as e:
  raise e
